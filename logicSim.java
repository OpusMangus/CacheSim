...
public class logicSim {
    ...
    public logicSim(int nSets, int setSize, int idSetSize, int bs, boolean wt, boolean wna, boolean split) {
        this.instRefCount = 0;
        this.dataRefCount = 0;
        ...
        if(split == false) {
            ...
            cache1 = new cache(nSets / 2, setSize / 2, idSetSize);
            cache2 = new cache(nSets / 2, setSize / 2, idSetSize);
        }
    ...
    public void runSim(ArrayList<instruccion> instrucciones){
        this.instRefCount = 0;
        this.dataRefCount = 0;
        this.instMissCount = 0;
        this.dataMissCount = 0;
